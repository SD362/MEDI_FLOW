 ...
 * Generates a formal, high-fidelity clinical record for completed consultations.
 * optimized for both dark-mode dashboard viewing and high-contrast physical printing.
 */
export default function AppointmentReceipt({ appointment }) {

    /**
     * Logic: Executes native browser print orchestration.
     * Media query overrides handle the transition from dark UI to professional white-paper formatting.
     */
    const handlePrint = () => {
        window.print();
    };
    ...
    return (
        <>
            <Head title={`Clinical Record - ${appointment.doctor.user.name}`} />
            ...
            <div className="min-h-screen p-6 font-sans text-slate-200 bg-[#0f172a] selection:bg-teal-500/30 md:p-12 lg:p-20 print:bg-white print:text-slate-950 print:p-0">
                ...
                <div id="receipt-content" className="max-w-4xl mx-auto bg-white/[0.02] backdrop-blur-3xl border border-white/10 rounded-[3rem] p-10 md:p-16 shadow-2xl relative overflow-hidden print:border-0 print:shadow-none print:bg-transparent">
                    ...
                    {/* Gradient Ambience (Omitted during print phase) */}
                    ...
                    <div className="flex flex-col items-start justify-between pb-12 mb-12 border-b md:flex-row md:items-center border-white/5 print:border-slate-200">
                        ...
                        <div className="text-left md:text-right">
                            ...
                            <h2 className="mb-2 font-mono text-2xl font-bold text-teal-400 print:text-teal-600">REF-{appointment.id.toString().padStart(6, '0')}</h2>
                            ...
                            <table className="w-full text-left">
                                ...
                                <tbody className="divide-y divide-white/5 print:divide-slate-200">
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-8 py-6 text-sm font-black text-right text-teal-400 print:text-teal-700">
                                            {appointment.schedule.start_time} — {appointment.schedule.end_time}
                                        </td>
                                    </tr>
                                    <tr className="bg-teal-500/[0.02] print:bg-teal-50/50">
                                        <td className="px-8 py-6 text-sm italic font-black text-teal-500 uppercase">Clinical Status</td>
                                        <td className="px-8 py-6 text-right">
                                            <span className="px-5 py-1.5 bg-teal-500 text-slate-900 rounded-lg text-[10px] font-black uppercase tracking-widest">
                                                {appointment.status}
                                            </span>
                                        </td>
                                    </tr>
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                @media print {
                    ...
                    body { background: white !important; color: #0f172a !important; font-family: sans-serif; }
